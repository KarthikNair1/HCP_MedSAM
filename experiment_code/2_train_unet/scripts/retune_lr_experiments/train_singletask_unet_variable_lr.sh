...
export label=$1
export lr=$2
export workdir='/gpfs/data/luilab/karthik/pediatric_seg_proj/results_copied_from_kn2347/unet_retune_lr_9-8-24/training'
...
do
    ...
    --data_frame_path /gpfs/data/luilab/karthik/pediatric_seg_proj/per_class_isolated_df_new/${label}/0.1/isolated_path_df_unet_FIXED.csv \
    ...
    -project_name singletask_unet -wandb_run_name label${label}_frac0.1_lr${lr}" >> ${workdir}/${label}/${lr}/log_for_${SLURM_JOB_ID}.log 2>&1 &
done
