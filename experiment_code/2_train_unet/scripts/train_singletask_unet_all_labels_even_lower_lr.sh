...
#SBATCH --output=/gpfs/data/luilab/karthik/pediatric_seg_proj/results_copied_from_kn2347/unet_singletask_testing_5-26-24/logs_training/fifth_pass/medsam_mgpus_%x-%j.out
#SBATCH --error=/gpfs/data/luilab/karthik/pediatric_seg_proj/results_copied_from_kn2347/unet_singletask_testing_5-26-24/logs_training/fifth_pass/medsam_mgpus_%x-%j.err
...
do
    ...
    -lr .000032 \
    -work_dir /gpfs/data/luilab/karthik/pediatric_seg_proj/results_copied_from_kn2347/unet_singletask_testing_5-26-24/logs_training/fifth_pass \
    -project_name singletask_unet -wandb_run_name label${SLURM_ARRAY_TASK_ID}" >> /gpfs/data/luilab/karthik/pediatric_seg_proj/results_copied_from_kn2347/unet_singletask_testing_5-26-24/logs_training/fifth_pass/log_for_${SLURM_JOB_ID}.log 2>&1 &
done
