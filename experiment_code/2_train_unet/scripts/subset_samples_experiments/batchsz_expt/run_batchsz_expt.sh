    ...
    do
        ...
        do
            ...
            do
                ...
                sbatch /gpfs/home/kn2347/HCP_MedSAM_project/experiment_code/2_train_unet/scripts/subset_samples_experiments/batchsz_expt/train_subset_singletask_unet_labels_variable_lr_and_batchsz.sbatch ${i} ${frac_arr[$j]} ${patience_arr[$j]} ${log_arr[$j]} ${u} ${df_path} ${workdir} ${batchsz_arr[$batchsz]}
                let idx=${idx}+1
            done
        done
    done
