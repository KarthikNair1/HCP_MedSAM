...
do
    ...
    do
        ...
        do
            ...
            df_path=/gpfs/data/luilab/karthik/pediatric_seg_proj/path_df_unet.csv
            workdir_root=/gpfs/data/luilab/karthik/pediatric_seg_proj/results_copied_from_kn2347/subsets_expt_unet_9-12-24/training/train_with_full_df
