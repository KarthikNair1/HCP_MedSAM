...
#SBATCH --output=/gpfs/data/luilab/karthik/pediatric_seg_proj/results_copied_from_kn2347/unet_singletask_testing_5-26-24/logs_training/lr1e-4/medsam_mgpus_%x-%j.out
#SBATCH --error=/gpfs/data/luilab/karthik/pediatric_seg_proj/results_copied_from_kn2347/unet_singletask_testing_5-26-24/logs_training/lr1e-4/medsam_mgpus_%x-%j.err
#SBATCH --time=04:00:00
#SBATCH --array=49,51,52,54,56,89,90,91,93
...
do
    ...
    -lr .0001 \
    -work_dir /gpfs/data/luilab/karthik/pediatric_seg_proj/results_copied_from_kn2347/unet_singletask_testing_5-26-24/logs_training/lr1e-4 \
    -project_name singletask_unet -wandb_run_name label${SLURM_ARRAY_TASK_ID}" >> /gpfs/data/luilab/karthik/pediatric_seg_proj/results_copied_from_kn2347/unet_singletask_testing_5-26-24/logs_training/lr1e-4/log_for_${SLURM_JOB_ID}.log 2>&1 &
done
