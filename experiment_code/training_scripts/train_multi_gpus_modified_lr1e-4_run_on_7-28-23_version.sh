...
do
    srun -lN1 --mem=400G --gres=gpu:1 -c $SLURM_CPUS_ON_NODE -N 1 -n 1 -r $i bash -c \
    "python /gpfs/home/kn2347/results/debug_7-27-23/MedSAM_finetune_hcp_ya_constant_bbox_all_tasks-20230728-011456/20230728-011456_train_multi_gpus_modified_multiclass.py \
        ...
        -work_dir /gpfs/home/kn2347/debug_8-3-23 \
        -batch_size 32 \
        -num_workers 4 \
        -num_epochs 150 \
        -lr 1e-4 \
