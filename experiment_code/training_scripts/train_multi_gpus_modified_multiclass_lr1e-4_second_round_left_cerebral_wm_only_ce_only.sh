...
do
    ...
    "python /gpfs/home/kn2347/MedSAM/train_multi_gpus_modified_multiclass.py \
        --data_frame_path /gpfs/data/luilab/karthik/pediatric_seg_proj/path_df_label1_only_with_bbox.csv \
        --df_desired_path /gpfs/home/kn2347/MedSAM/left_cerebral_wm_only_name_class_mapping.csv \
