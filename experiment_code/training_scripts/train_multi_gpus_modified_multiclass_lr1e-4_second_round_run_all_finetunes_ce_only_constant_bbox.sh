...
#SBATCH --job-name=constant_bbox_ft
#SBATCH --mem=100GB
#SBATCH --gres=gpu:1
...
do
    ...
    "python /gpfs/home/kn2347/MedSAM/train_multi_gpus_modified_multiclass.py \
        --data_frame_path /gpfs/data/luilab/karthik/pediatric_seg_proj/per_class_isolated_df/medsam/constant_bbox/path_df_label${SLURM_ARRAY_TASK_ID}_constant_bbox.csv \
        ...
        --wandb_run_name label${SLURM_ARRAY_TASK_ID}_finetune_10epochs_constant_bbox \
        -checkpoint /gpfs/home/kn2347/MedSAM/medsam_vit_b.pth \
        -work_dir /gpfs/data/luilab/karthik/pediatric_seg_proj/results_copied_from_kn2347/second_round_constant_bbox_baseline_8-15-23 \
        -label_id 1 \
        -batch_size 256 \
        -num_workers 4 \
        -num_epochs 10 \
