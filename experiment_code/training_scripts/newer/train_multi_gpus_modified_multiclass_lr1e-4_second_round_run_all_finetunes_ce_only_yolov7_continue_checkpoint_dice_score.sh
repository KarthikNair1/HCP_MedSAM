...
do
    ...
    "python /gpfs/home/kn2347/MedSAM/train_multi_gpus_modified_multiclass.py \
        ...
        --wandb_run_name label${SLURM_ARRAY_TASK_ID}_finetune_10epochs_yolov7_continue_ckpt_dice_score \
        -checkpoint /gpfs/home/kn2347/MedSAM/medsam_vit_b.pth \
        -work_dir /gpfs/data/luilab/karthik/pediatric_seg_proj/results_copied_from_kn2347/try_dice_loss_switch_from_ckpt_8-17-23 \
        -label_id 1 \
        -batch_size 256 \
        -num_workers 4 \
        -num_epochs 60 \
