...
do
    ...
    "python /gpfs/home/kn2347/MedSAM/train_multi_gpus_modified_multiclass.py \
        --data_frame_path /gpfs/data/luilab/karthik/pediatric_seg_proj/per_class_isolated_df/yolov7/conf_thresh_010/path_df_pooled_labels_only_with_bbox_yolov7.csv \
        ...
        --wandb_run_name pooled_labels_yolov7_confthresh_0.10 \
        -checkpoint /gpfs/home/kn2347/MedSAM/medsam_vit_b.pth \
        -work_dir /gpfs/data/luilab/karthik/pediatric_seg_proj/results_copied_from_kn2347/pool_model_confthresh_010 \
        -label_id 1 \
        -batch_size 64 \
        -num_workers 4 \
        -num_epochs 30 \
