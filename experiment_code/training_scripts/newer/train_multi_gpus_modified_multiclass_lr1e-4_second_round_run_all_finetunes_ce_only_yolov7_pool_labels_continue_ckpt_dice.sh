...
do
    ...
    "python /gpfs/home/kn2347/MedSAM/train_multi_gpus_modified_multiclass.py \
        ...
        --wandb_run_name pooled_labels_yolov7_ckpt_continue_dice_loss \
        -checkpoint /gpfs/home/kn2347/MedSAM/medsam_vit_b.pth \
        -work_dir /gpfs/data/luilab/karthik/pediatric_seg_proj/results_copied_from_kn2347/pooled_labels_ckpt_continue_8-22-23 \
        -label_id 1 \
        -batch_size 32 \
        -num_workers 4 \
        -num_epochs 60 \
        ...
        --grad_acc_steps 1 \
        --node_rank ${i} \
        --resume /gpfs/data/luilab/karthik/pediatric_seg_proj/results_copied_from_kn2347/pooled_labels_8-20-23/MedSAM_finetune_hcp_ya_second_round_with_bbox-20230820-215516/medsam_model_latest.pth \
