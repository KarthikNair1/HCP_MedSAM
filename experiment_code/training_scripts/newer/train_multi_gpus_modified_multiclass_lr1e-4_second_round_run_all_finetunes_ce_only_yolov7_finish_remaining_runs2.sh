...
#SBATCH --job-name=yolov7_ft_long
#SBATCH --mem=100GB
#SBATCH --gres=gpu:1
...
#SBATCH --array=84,86,87,88,89,90
...
do
    ...
    "python /gpfs/home/kn2347/MedSAM/train_multi_gpus_modified_multiclass.py \
        ...
        --wandb_run_name label${SLURM_ARRAY_TASK_ID}_finetune_30epochs_yolov7_long \
        -checkpoint /gpfs/home/kn2347/MedSAM/medsam_vit_b.pth \
        -work_dir /gpfs/data/luilab/karthik/pediatric_seg_proj/results_copied_from_kn2347/second_round_w_bbox_yolov7_finetunes_longer_8-17-23/label${SLURM_ARRAY_TASK_ID} \
        -label_id 1 \
        -batch_size 256 \
        -num_workers 4 \
        -num_epochs 30 \
