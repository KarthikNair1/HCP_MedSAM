...
do
    ...
    "python /gpfs/home/kn2347/MedSAM/train_multi_gpus_modified_multiclass.py \
        --data_frame_path /gpfs/data/luilab/karthik/pediatric_seg_proj/per_class_isolated_df/yolov7/path_df_label74_only_with_bbox_yolov7.csv \
        --df_desired_path /gpfs/home/kn2347/MedSAM/class_mappings/label74_only_name_class_mapping.csv \
        ...
        --wandb_run_name label74_finetune_10epochs_yolov7_try2 \
        -checkpoint /gpfs/home/kn2347/MedSAM/medsam_vit_b.pth \
        -work_dir /gpfs/home/kn2347/results/second_round_w_bbox_all_finetunes_8-13-23 \
        -label_id 1 \
        -batch_size 256 \
        -num_workers 4 \
        -num_epochs 10 \
