...
do
    srun -lN1 --mem=100G --gres=gpu:2 -c $SLURM_CPUS_ON_NODE -N 1 -n 1 -r $i bash -c \
    "python /gpfs/home/kn2347/MedSAM/train_multi_gpus_modified_multiclass.py \
        ...
        --resume '/gpfs/home/kn2347/results/ce_only_resume_training_from_checkpoint_8-9-23/MedSAM_finetune_hcp_ya_constant_bbox_all_tasks-20230810-005849/medsam_model_best.pth' \
        -work_dir /gpfs/home/kn2347/results/ce_only_resume_training_from_checkpoint_8-9-23 \
        -batch_size 16 \
        -num_workers 4 \
        -num_epochs 150 \
        --lambda_dice 0 \
