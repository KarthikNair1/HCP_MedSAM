...
do
    ...
    "python /gpfs/home/kn2347/MedSAM/train_multi_gpus_modified_multiclass.py \
        --data_frame_path /gpfs/data/luilab/karthik/pediatric_seg_proj/per_class_isolated_df/yolov7/path_df_label9_only_with_bbox_yolov7.csv \
        --df_desired_path /gpfs/home/kn2347/MedSAM/class_mappings/label9_only_name_class_mapping.csv \
        -train_test_splits /gpfs/data/luilab/karthik/pediatric_seg_proj/train_val_test_split.pickle \
        -task_name MedSAM_finetune_hcp_ya_second_round_with_bbox \
        --wandb_run_name label9_finetune_10epochs_yolov7 \
        -checkpoint /gpfs/home/kn2347/MedSAM/medsam_vit_b.pth \
        -work_dir /gpfs/data/luilab/karthik/pediatric_seg_proj/results_copied_from_kn2347/second_round_w_bbox_yolov7_finetunes_8-15-23 \
        -label_id 1 \
        -batch_size 256 \
        -num_workers 4 \
        -num_epochs 6 \
        ...
        -use_wandb True \
        -use_amp \
        --resume /gpfs/data/luilab/karthik/pediatric_seg_proj/results_copied_from_kn2347/second_round_w_bbox_yolov7_finetunes_8-15-23/MedSAM_finetune_hcp_ya_second_round_with_bbox-20230816-220020/medsam_model_latest.pth \
