...
do
    ...
    "python /gpfs/home/kn2347/MedSAM/train_multi_gpus_modified_multiclass.py \
        --data_frame_path /gpfs/data/luilab/karthik/pediatric_seg_proj/per_class_isolated_df/path_df_label${SLURM_ARRAY_TASK_ID}_only_with_bbox.csv \
        ...
        --wandb_run_name label${SLURM_ARRAY_TASK_ID}_finetune_10epochs \
