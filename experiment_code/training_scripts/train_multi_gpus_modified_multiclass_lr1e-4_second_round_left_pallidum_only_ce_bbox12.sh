...
do
    srun -lN1 --mem=200G --gres=gpu:1 -c $SLURM_CPUS_ON_NODE -N 1 -n 1 -r $i bash -c \
    "python /gpfs/home/kn2347/MedSAM/train_multi_gpus_modified_multiclass.py \
        --data_frame_path /gpfs/data/luilab/karthik/pediatric_seg_proj/path_df_label9_left_pallidum_only_with_bbox.csv \
        --df_desired_path /gpfs/home/kn2347/MedSAM/left_pallidum_only_name_class_mapping.csv \
        ...
        -work_dir /gpfs/home/kn2347/results/second_round_with_bbox_8-12-23 \
        -label_id 1 \
        --bbox_shift 12 \
        -batch_size 256 \
        -num_workers 4 \
