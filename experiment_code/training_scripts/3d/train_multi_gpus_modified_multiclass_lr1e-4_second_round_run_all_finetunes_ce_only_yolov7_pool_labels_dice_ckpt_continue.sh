...
do
    ...
    "python /gpfs/home/kn2347/MedSAM/train_multi_gpus_modified_multiclass_3D.py \
        ...
        --grad_acc_steps 1 \
        --node_rank ${i} \
        --resume /gpfs/data/luilab/karthik/pediatric_seg_proj/results_copied_from_kn2347/3d_model_8-31-23/MedSAM_finetune_3D-20230901-033756/medsam_model_latest.pth \
